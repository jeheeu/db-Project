...
<?php
  ...
  $query ="select * from posting order by postingIdx desc";
...
transform: translate( 20%, 0% );" align="center">
    <br><br>
    <form  action='uploadDo.php' method='post'
    target="payviewer" onsubmit = "window.open('uploadDo.php', 'payviewer', 'width=300, height=100,left=400, top=50, scrollbars');"
    ...
    <td>판매금액</td>
    <td><input type="number"name="price" size=20>&emsp;&emsp;
        <input type="checkbox" name="priceDeal"> 가격 제안     
    </td>
    </tr>
    <tr>
        <td>카테고리</td>
    ...
    <tr>
        <td>사진 ( 최대 4장 )</td>
        <td><input  type='file' name='upload[]' id='upload' multiple='multiple'></td>
    </tr>
    <tr>
    <td>내용</td>
