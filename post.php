    ...
    <?php
        ...
        function printpage(int $page){
            ...
            if(array_key_exists('board_search', $_POST)){
                ...
                $conn = mysqli_connect("localhost", "root","", "oxmall" );
                $sql = "SELECT * FROM posting limit $start_data, 10;";
                $result = mysqli_query($conn, $sql);
                while($row = mysqli_fetch_array($result)){
    ?>
                    <tr>
                        <td width = "50" align = "center"><?=$row['postingIdx']?></td>
                        <td width = "500" align = "center"><a href = 'view.php?number=<?= $row['postingIdx']?>'><?=$row['title']?></a></td>
                        <td width = "100" align = "center"><?=$row['userId']?></td>
